...
@Component({
    selector: 'app-modal-filter-product-erp',
    templateUrl: './modal-filter-product-erp.component.html',
    styleUrls: ['./modal-filter-product-erp.component.scss']
})
export class ModalFilterProductErpComponent implements OnInit {
    titleModal: string = 'Filtro';
    model: FilterProductLinkErp;
    ...
    constructor(
        ...
        public dialogRef: MatDialogRef<ModalFilterProductErpComponent>,
        @Inject(MAT_DIALOG_DATA) public data: FilterProductLinkErpSearch
    ) { }
